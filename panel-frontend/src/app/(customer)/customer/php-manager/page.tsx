  ...
  const fetchConfig = async () => {
    try {
      ...
      if (res.data.success) {
        ...
        setMemoryLimit(parseInt(settings.memory_limit || "256", 10));
        setMaxExecutionTime(parseInt(settings.max_execution_time || "30", 10));
    ...
    <div className="space-y-6 animate-in fade-in duration-300">
      ...
      {loading ? (
        <div className="bg-white border border-gray-200 rounded-xl p-12 flex flex-col items-center justify-center space-y-4">
          ...
          <p className="text-sm font-medium text-gray-500">Querying PHP ini structures...</p>
        </div>
      ) : (
        <>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              ...
              <div className="bg-white border border-gray-200 rounded-xl p-6 shadow-sm space-y-4 h-fit">
                ...
                <p className="text-xs text-gray-500 leading-relaxed font-semibold">
                  All custom PHP parameters are applied strictly within your `/home/{username}/php.ini` context file. Modifications take effect instantly upon write inside LSWS handlers.
                </p>
              </div>
            </div>
          )}
